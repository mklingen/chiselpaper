...
and then use a rasterization algorithm \mathbf{TODO: CITE RASTERIZATION
...
endpoint of a ray from the depth camera.
...
camera functions as a global map of where the user has been.
