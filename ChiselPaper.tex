...
dense 3D mapping \cite{Hartley2004} using a mobile Google \Tango
\cite{Tango} device by using a dynamic spatially hashed \cite{NiessnerHashing} truncated
...
directly using TSDF data (\sref{section:robot}).
...
data (that is, information about what parts of the scene do not contain an
