...
time) outdoor scenes in real-time (\figref{fig:overhead_night}).
...
note that using both space carving \emph{and} raycasting is not fast enough for
real-time mapping on the device using our system.
